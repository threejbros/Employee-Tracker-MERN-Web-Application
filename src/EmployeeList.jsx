                ...
                <tr>
                    ...
                    <td>
                        ...
                        <Modal show={this.state.modalVisible} onHide={this.toggleModal} centered>
                            ...
                            <Modal.Footer>
                                <Button type="button" variant="danger" size="sm"className="mt-4" onClick={this.toggleModal}>
                                    Cancel
                                </Button>
                                <Button type="button" variant="success" size="sm"className="mt-4" onClick={this.onDeleteClick}>
                                    Yes
                                </Button>
                            </Modal.Footer>
                        </Modal>
