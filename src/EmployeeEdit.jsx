                    ...
                    <Card.Text>
                        <Container fluid>
                            <form name="employeeUpdate" onSubmit={this.handleSubmit}>
                                ...
                                <Button type="submit" variant="primary" size="sm" className="my-3">Update Employee </Button><br/>
                                <Alert 
                                    variant={this.state.alertColor} 
                                    show={this.state.alertVisible} 
                                    dismissible 
                                    onClose={() => this.setState({alertVisible: false})}>{this.state.alertMessage}</Alert>
                            </form>
                        </Container>
                    </Card.Text>
                </Card.Body>
